  ...
  function render() {
    ...
    container.innerHTML = `
      ...
      <div class="charts-grid">
        ...
        <div class="chart-box full"><div class="chart-title">Viajes acumulados a la fecha <span class="chart-badge">2023–2026</span></div><div style="position:relative;width:100%;height:300px"><canvas id="vp-acum-viajes"></canvas></div></div>
        <div class="chart-box full"><div class="chart-title">Piezas acumuladas a la fecha <span class="chart-badge">2023–2026</span></div><div style="position:relative;width:100%;height:300px"><canvas id="vp-acum-piezas"></canvas></div></div>
        ${hayLocFor ? `
